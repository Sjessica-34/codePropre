...
/**
 * Classe contenant les principales fonctions d'administration du zoo
 *
 */
public class ZooService {
    ...
    /**
     * Affichage de la liste de tous les animaux du zoo
     * ou d'une zone en particulier
     */
    public void afficherListeAnimaux(Scanner sc, Zoo zoo) {
        ...
        System.out.println("5 - Afficher la liste complète");
    ...
    /**
     * @param sc Ajout d'un animal dans une zone du zoo
     */
    ...
    /**
     * @param sc
     * @param zoo Renvoie la quantité de nourriture consommée par jour et par zone
     */
    public void calculerRation(Scanner sc, Zoo zoo) {
        System.out.println(
                "Indiquer la zone pour calculer la quantité de nourriture nécessaire");
        for (int i = 0; i < zoo.getListeZones().size(); i++) {
            System.out.println(i + 1 + " - " + (zoo.getListeZones().get(i).getClass().getSimpleName()));
        }
        ...
        switch (castSelection) {
            case 1:
                ...
                Zone zone1 = zoo.getListeZones().get(j);
                System.out.println(zone1.calculerKgsNourritureParJour() + " kg de nourriture par jour");

                break;
            case 2:

                Zone zone2 = zoo.getListeZones().get(j);
                System.out.println(zone2.calculerKgsNourritureParJour() + " kg de nourriture par jour");

                break;
            case 3:

                Zone zone3 = zoo.getListeZones().get(j);
                System.out.println(zone3.calculerKgsNourritureParJour() + " kg de nourriture par jour");

                break;
            case 4:

                Zone zone4 = zoo.getListeZones().get(j);
                System.out.println(zone4.calculerKgsNourritureParJour() + " kg de nourriture par jour");
